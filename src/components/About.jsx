...
export default function About() {
    ...
    return (
        ...
        >
            ...
            <p className="text-[#f2e6f2ca] font-abel sm:text-[1.12em] tracking-wider w-3/4 text-left text-wrap whitespace-pre-line">
                <span>
                    I'm a Full-Stack AI Engineer{' '}
                    <span className="italic font-bold">2+ years</span> of
                    experience building{' '}
                    ...
                    , <span className="italic font-bold">RAG pipelines</span>,
                    and domain-specific conversational AI using{' '}
                    <span className="italic font-bold">LangChain</span>,{' '}
                    <span className="italic font-bold">LangGraph</span>,{' '}
                    <span className="italic font-bold">Google ADK</span> and{' '}
                    <span className="italic font-bold">MCP</span>.<br />
                    Experienced in architecting scalable{' '}
                    <span className="italic font-bold">React</span> applications
                    with optimized state management, structured network/store
                    layers, and{' '}
                    <span className="italic font-bold">WCAG 2.1 AA</span>{' '}
                    compliant UI systems.
                    <br />
                    Led development of a{' '}
                    <span className="italic font-bold">
                        React-based NPM package and Chrome extension
                    </span>{' '}
                    enabling internal teams to integrate and leverage platform
