...
const name1 = 'Full-Stack AI Engineer (Agentic AI + React )'
...
export default function Intro() {
    ...
    return (
        <div className="relative justify-center items-end select-none mt-10 xs:mt-0 border-b sm:h-[400px] py-5 sm:py-0 border-[#9e9e9e43] w-[80%] flex flex-col">
            ...
            {/* Blur decorations */}
            <div className="w-[220px] sm:flex left-[-160%] hidden h-[220px] sm:scale-[6] scale-[3] rounded-full -z-[40] absolute md:left-[-90%] top-0 bg-[#1d2486] blur-[200px]" />
