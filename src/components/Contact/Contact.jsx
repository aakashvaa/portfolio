    ...
    return (
        ...
        >
            <ToastContainer
                ...
                hideProgressBar
                newestOnTop
                toastStyle={{ backgroundColor: '#0D0E11' }}
            />
                ...
                >
                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            {/* create a open email button */}
                            <div className="relative flex items-center justify-center my-6">
                                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
                                <span className="px-4 text-white/60 text-sm font-medium bg-black/20 backdrop-blur-sm rounded-full border border-white/10">
                                    Or
                                </span>
                                <div className="flex-1 h-px bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
                            </div>
