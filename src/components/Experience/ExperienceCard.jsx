...
import { TechTag } from '../Skill/TechTag'
    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="text-white/50 tracking-wide mt-3 text-sm leading-relaxed">
                    {description.map((section, idx) => (
                        <div key={idx} className="mb-4">
                            <h4
                                className={`font-semibold text-base mb-2 ${
                                    isHovered ? 'text-white/80' : 'text-white/70'
                                }`}
                            >
                                {section.title}
                            </h4>
                ...
                <div className="flex pt-4 flex-wrap gap-2.5 text-[5px]">
