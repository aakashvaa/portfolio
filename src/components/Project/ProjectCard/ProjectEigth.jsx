...
export default function ProjectEight({ el, index }) {
            ...
            <div className="w-full h-full bg-[#00000044] relative rounded-xl">
                ...
                <div className="m-2 relative">
                    ...
                    <AnimatePresence>
                        {showDetail && (
                            <motion.div
                                initial={{ opacity: 0, y: 0, scale: 0.95, rotateZ: -5 }}
                                animate={{
                                    opacity: [0, 1, 1],
                                    y: [0, -150, -100],
                                    scale: [0.95, 1.05, 1],
                                    ...
                                    transition: {
                                        ...
                                        y: {
                                            type: 'keyframes',
                                            ease: [[0.34, 0.1, 0.3, 1], [0.33, 1.2, 0.64, 1]],
                                            duration: 0.8,
                                        },
                                        scale: {
                                            type: 'spring',
                                ...
                                exit={{
                                    ...
                                    transition: {
                                        ...
                                        opacity: { delay: 0.8, duration: 0.2, ease: 'easeOut' },
                                    },
                                }}
                                className="absolute -bottom-16 bg-black/10 left-0 backdrop-blur-xl rounded-xl p-6 shadow-2xl"
                            >
                                <p className="text-sm text-gray-300 contrast-200">{description}</p>
                ...
                >
                    <div className="flex justify-center items-center">
                        <h4 className="px-2 font-thin w-full tracking-widest">{title}</h4>
                        <div className="contents space-x-3">
                            <GithubIcon url={links[0]} />
                            <Live url={links[1]} />
                        </div>
                    </div>
                </div>
