      ...
      >
        ...
        {showDetail && (
          <motion.div
            ...
            className={`absolute sm:flex flex-col justify-between hidden w-[300px] -bottom-3 -right-5 items-center  z-50 border-2 backdrop-blur-xl p-5  rounded-md drop-shadow-lg px-3 border-[#b2b2b222]`}
          >
            <h1>
